...
REM Create and set up virtual environments for openai-webjob and openai
for %%E in (openai-webjob openai) do (
    set "VENV_NAME=%%E"
    ...
    if not exist "!VENV_PATH!" (
        ...
        if exist "!VENV_PATH!\Scripts\activate.bat" (
            ...
            if "!VENV_NAME!"=="openai-webjob" (
                "!VENV_PATH!\Scripts\pip" install -r "!ROOT!\openai\webjob\requirements.txt"
            ) else (
                "!VENV_PATH!\Scripts\pip" install -r "!ROOT!\openai\requirements.txt"
            )
