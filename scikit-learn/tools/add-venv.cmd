...
REM Create and set up virtual environments for scikit-learn-webjob and scikit-learn
for %%E in (scikit-learn-webjob scikit-learn) do (
    set "VENV_NAME=%%E"
    ...
    if not exist "!VENV_PATH!" (
        ...
        if exist "!VENV_PATH!\Scripts\activate.bat" (
            ...
            if "!VENV_NAME!"=="scikit-learn-webjob" (
                "!VENV_PATH!\Scripts\pip" install -r "!ROOT!\scikit-learn\webjob\requirements.txt"
            ) else (
                "!VENV_PATH!\Scripts\pip" install -r "!ROOT!\scikit-learn\requirements.txt"
            )
