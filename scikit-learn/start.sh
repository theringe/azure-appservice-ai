...
# Start the application using the new scikit-learn virtual environment
source $NEW_VENV_FOLDER/scikit-learn/bin/activate
$NEW_VENV_FOLDER/scikit-learn/bin/python $ROOT/api/app.py
